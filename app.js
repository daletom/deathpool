	...
	methods: {
    	post: function(){
    		var deathpoolData = {
    			name: this.form.name,
    			code: this.form.code,
    			jonDeath: this.form.jonDeath,
    			sansaDeath: this.form.sansaDeath,
    			aryaDeath: this.form.aryaDeath,
    			branDeath: this.form.branDeath,
    			jaimeDeath: this.form.jaimeDeath, 
    			cerseiDeath: this.form.cerseiDeath,
    			tyrionDeath: this.form.tyrionDeath,
    			mountainDeath: this.form.mountainDeath,
    			daenerysDeath: this.form.daenerysDeath,
    			missandeiDeath: this.form.missandeiDeath,
    			greywormDeath: this.form.greywormDeath,
    			euronDeath: this.form.euronDeath,
    			yaraDeath: this.form.yaraDeath,
    			theonDeath: this.form.theonDeath,
    			jorahDeath: this.form.jorahDeath,
    			melisandreDeath: this.form.melisandreDeath,
    			samwellDeath: this.form.samwellDeath,
    			gillyDeath: this.form.gillyDeath,
    			samDeath: this.form.samDeath,
    			bericDeath: this.form.bericDeath,
    			houndDeath: this.form.houndDeath,
    			varysDeath: this.form.varysDeath,
    			brienneDeath: this.form.brienneDeath,
    			podrickDeath: this.form.podrickDeath,
    			davosDeath: this.form.davosDeath,
